...
For beginners of statistics, the question and formulation of mean and standard deviation can be found [here](https://pleasesolve.wordpress.com/statistics/mean-standard-deviation/). And for a fun explanation on moment of area and its relationship with mean and standard deviation can be found in this [Youtube video](https://www.youtube.com/watch?v=zzxFSbJzoDI).
